    ...
    return (
      <React.Fragment>
        ...
        <p className='lead description'>
          ...
          action has been taken by the admin. s{' '}
        </p>
      ...
      <div>
        <section className='my-5'>
          <div className='container'>
            <div className='row'>
              <div className='col-md-7 col-lg-7 col-sm-12 text-white side-showcase'>
              ...
              <div className='col-md-5 col-lg-5 col-sm-12'>
                ...
                <form onSubmit={this.loginUser.bind(this)}>
                  ...
                  <button
                    type='submit'
                    className='btn btn-block btn-lg bg-dark text-white login-custom-btn'
                  >
        ...
        <div className='container mt-5'>
          {this.state.status === true ? (
            <p className='lead mt-3 text-white text-center'>
              User Logged In Successfully
            </p>
          ) : (
            <p className='lead text-white mt-3 text-center'>
              {' '}
              {this.state.error}{' '}
            </p>
          )}
...
const mapDispatchToProps = dispatch =>
  bindActionCreators(
    {
      startLogin: loginViaGoogle,
      loginWithEmailAndPassword: startLogin
    },
    dispatch
  );
