        ...
        <table className='table table-dark text-white'>
          <tbody>
            <tr>
              ...
              <td>
                {this.props.reports.totalCities === 0 ? (
                  <p> Loading... </p>
                ) : (
                  <span>{this.props.reports.totalCities}</span>
                )}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {this.props.reports.crimeTotal === 0 ? (
                  <p> Loading... </p>
                ) : (
                  this.props.reports.crimeTotal
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {this.props.reports.complaint_total === 0 ? (
                  <p> Loading... </p>
                ) : (
                  this.props.reports.complaint_total
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {this.props.reports.missing_person_total === 0 ? (
                  <p> Loading... </p>
                ) : (
                  this.props.reports.missing_person_total
                )}
              </td>
            </tr>
          </tbody>
          ...
          <tfoot>
            <tr>
              <th>Total Reports</th>
              <td>
                {this.props.reports.totalReports === 0 ? (
                  <p> Loading... </p>
                ) : (
                  this.props.reports.totalReports
                )}
              </td>
            </tr>
          </tfoot>
...
const structureData = object => {
  ...
  let crimeTotal = allreports.filter(
    singleReport => singleReport.crimeType === 'crimes'
  );
  let complaint_total = allreports.filter(
    singleReport => singleReport.crimeType === 'complaints'
  );
  let missing_person_total = allreports.filter(
    singleReport => singleReport.crimeType === 'missing_person'
  );
